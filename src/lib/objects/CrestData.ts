...
export const CREST_DATA: Record<CrestType, CrestInfo> = {
    [CrestType.Architect]: {
        ...
        padding: 18,
        slots: [
            { id: 1, type: SlotType.RED_UP, x: 66, y: 39 },
            { id: 2, type: SlotType.RED_CENTER, x: 66, y: 76.5 },
            { id: 3, type: SlotType.RED_DOWN, x: 66, y: 115 },
    ...
    [CrestType.Beast]: {
        ...
        padding: 24,
        slots: [
            { id: 1, type: SlotType.WHITE_CENTER, x: 66, y: 73 },
            { id: 2, type: SlotType.RED_UP, x: 66, y: 34 },
            { id: 3, type: SlotType.RED_DOWN, x: 66, y: 111 },
    ...
    [CrestType.Hunter2]: {
        ...
        padding: 32,
        slots: [
            { id: 1,type: SlotType.WHITE_CENTER, x: 66, y: 95.5 },
            { id: 2,type: SlotType.RED_UP, x: 66, y: 53 },
            { id: 3,type: SlotType.RED_DOWN, x: 66, y: 137 },
    ...
    [CrestType.Hunter3]: {
        ...
        padding: 24,
        slots: [
            { id: 1, type: SlotType.WHITE_CENTER, x: 66, y: 103 },
            { id: 2, type: SlotType.RED_UP, x: 66, y: 60.5 },
            { id: 3, type: SlotType.RED_DOWN, x: 66, y: 144 },
    ...
    [CrestType.Shaman]: {
        ...
        padding: 20,
        slots: [
            { id: 1, type: SlotType.WHITE_UP, x: 64, y: 29 },
            { id: 2, type: SlotType.WHITE_CENTER, x: 64, y: 67.5 },
            { id: 3, type: SlotType.WHITE_DOWN, x: 64, y: 108 },
    ...
    [CrestType.Wanderer]:{
        ...
        padding: 26,
        slots: [
            { id: 1, type: SlotType.WHITE_CENTER, x: 66, y: 50 },
            { id: 2, type: SlotType.RED_UP, x: 66, y: 9 },
    ...
    [CrestType.Witch]: {
        ...
        padding: 16,
        slots: [
            { id: 1, type: SlotType.WHITE_CENTER, x: 70, y: 75 },
            { id: 2, type: SlotType.RED_UP, x: 61, y:25 },
            { id: 3, type: SlotType.RED_DOWN, x: 72, y: 122 },
