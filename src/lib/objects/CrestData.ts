...
export const CREST_DATA: Record<CrestType, CrestInfo> = {
    ...
    [CrestType.Hunter2]: {
        ...
        padding: [0, 16, 32, 16],
        slots: [
            { id: 1,type: SlotType.Skill, direction: SlotDirection.Center, x: 50, y: 81.25 - 16 },
            { id: 2,type: SlotType.Attack, direction: SlotDirection.Up, x: 50, y: 38.75 - 16 },
            { id: 3,type: SlotType.Attack, direction: SlotDirection.Down, x: 50, y: 122.75 - 16},
            { id: 4,type: SlotType.Defense, x: -10, y: 77.75 - 16},
            { id: 5,type: SlotType.Defense, x: 16, y: 105.75 - 16},
            { id: 6,type: SlotType.Explore, x: 84, y: 105.75 - 16},
            { id: 7,type: SlotType.Explore, x: 110, y: 77.75 - 16},
        ], 
        swingSpeed: 4,
        swingSpeedBrew: 3.6,
    },
    [CrestType.Hunter3]: {
        ...
        padding: [0, 8, 16, 8],
        slots: [
            { id: 1, type: SlotType.Skill, direction: SlotDirection.Center, x: 50, y: 88.75 - 8 },
            { id: 2, type: SlotType.Attack, direction: SlotDirection.Up, x: 50, y: 46.25 - 8 },
            { id: 3, type: SlotType.Attack, direction: SlotDirection.Down, x: 50, y: 129.75 - 8 },
            { id: 4, type: SlotType.Defense, x: -10, y: 85.75 - 8 },
            { id: 5, type: SlotType.Defense, x: 16, y: 112.75 - 8 },
            { id: 6, type: SlotType.Explore, x: 84, y: 112.75 - 8 },
            { id: 7, type: SlotType.Explore, x: 110, y: 85.75 - 8 },
        ], 
        swingSpeed: 4,
        swingSpeedBrew: 3.6,
    },
    [CrestType.Hunter4]: {
        ...
        padding: [0, 12, 24, 12],
        slots: [
            { id: 1, type: SlotType.Skill, direction: SlotDirection.Center, x: 50, y: 88.75 - 12 },
            { id: 2, type: SlotType.Attack, direction: SlotDirection.Up, x: 50, y: 46.25- 12 },
            { id: 3, type: SlotType.Attack, direction: SlotDirection.Down, x: 50, y: 129.75 - 12 },
            { id: 4, type: SlotType.Defense, x: -10, y: 85.75 - 12 },
            { id: 5, type: SlotType.Defense, x: 16, y: 112.75 - 12 },
            { id: 6, type: SlotType.Explore, x: 84, y: 112.75 - 12 },
            { id: 7, type: SlotType.Explore, x: 110, y: 85.75 - 12 },
        ], 
        swingSpeed: 4,
        swingSpeedBrew: 3.6,
    },
    ...
    [CrestType.Wanderer]:{
        ...
        padding: [20, 10, 0, 10],
        slots: [
            { id: 1, type: SlotType.Skill, direction: SlotDirection.Center, x: 50, y: 35.75 + 10 },
            { id: 2, type: SlotType.Attack, direction: SlotDirection.Up, x: 50, y: -5.25 + 10 },
            { id: 3, type: SlotType.Defense, x: 5, y: 11.75 + 10 },
            { id: 4, type: SlotType.Defense, x: 95, y: 11.75 + 10 },
            { id: 5, type: SlotType.Explore, x: -0.5, y: 67.75 + 10 },
            { id: 6, type: SlotType.Explore, x: 50, y: 96.75 + 10 },
            { id: 7, type: SlotType.Explore, x: 100.5, y: 67.75 + 10 },
        ], 
        swingSpeed: 3,
        swingSpeedBrew: 2.6,
    },
